...
If you prefer to keep local changes outside of the project checkout, follow the
<<in-depth/flakes.adoc#,personal flake guide>> and the `examples/device-flake` template to
build fully customized images from your own repository.
